...
module.exports = function(_, _fantasy, functionalHelpers){
    ...
    var isNonSystemEvent = _.compose(_.chain(fh.doesNotStartWith('$')), _.chain(fh.safeProp('EventType')), fh.safeProp('Event'));
    ...
    var isEventTypeEvent = _.compose(_.chain(fh.maybeMatches('event')), _.chain(fh.safeProp('streamType')), parseMetadata);
